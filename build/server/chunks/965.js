...
const _normalizetrailingslash = __webpack_require__(1721);
...
function getDomainLocale(path, locale, locales, domainLocales) {
    if (true) {
        const normalizeLocalePath = (__webpack_require__(8949).normalizeLocalePath);
        const detectDomainLocale = (__webpack_require__(3196).detectDomainLocale);
...
const _addlocale = __webpack_require__(9626);
const _routercontext = __webpack_require__(4964);
const _approutercontext = __webpack_require__(3280);
const _useintersection = __webpack_require__(477);
const _getdomainlocale = __webpack_require__(93);
const _addbasepath = __webpack_require__(6908);
const _routerreducertypes = __webpack_require__(5);
...
const _requestidlecallback = __webpack_require__(4852);
